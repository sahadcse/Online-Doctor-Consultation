...
const DoctorProfile = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${baseURL}/api/users/doctor/profile/${userData._id}`, {
        headers: {
  ...
  const handleUpdate = (updatedData: Partial<Patient>) => {
    ...
    axios
      .put(`${baseURL}/api/users/doctor/update`, updatedData, {
        headers: {
          Authorization: `Bearer ${token}`,
      ...
      .then((response) => {
        ...
        router.push(`/doctor/profile`); // Redirect to the updated profile page
