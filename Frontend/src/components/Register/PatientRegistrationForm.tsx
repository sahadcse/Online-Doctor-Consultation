...
const PatientRegistrationForm = () => {
    ...
    const validate = (): boolean => {
        ...
        if (!formData.height.feet) newErrors['height.feet'] = 'Height (Feet) is required';
        if (!formData.height.inches) newErrors['height.inches'] = 'Height (Inches) is required';
        if (!formData.weight.value) newErrors['weight.value'] = 'Weight is required';
        if (!formData.weight.unit) newErrors['weight.unit'] = 'Weight Unit is required';
        if (!formData.emergency_contact.name) newErrors['emergency_contact.name'] = 'Emergency Contact Name is required';
        if (!formData.emergency_contact.phone_number) newErrors['emergency_contact.phone_number'] = 'Emergency Contact Phone Number is required';
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex space-x-4">
                    <div className="form-control flex-1">
                        ...
                        <input type="text" name="full_name" placeholder="Full Name" value={formData.full_name} onChange={handleChange} className="input input-bordered" />
                ...
                <div className="flex space-x-4">
                    <div className="form-control flex-1">
                        ...
                        <input type="text" name="phone_number" placeholder="Phone Number" value={formData.phone_number} onChange={handleChange} className="input input-bordered" />
                    ...
                    <div className="form-control flex-1">
                        ...
                        <input type="date" name="date_of_birth" placeholder="Date of Birth" value={formData.date_of_birth} onChange={handleChange} className="input input-bordered" />
                ...
                <div className="flex space-x-4">
                    ...
                    <div className="form-control flex-1">
                        ...
                        <select name="blood_group" value={formData.blood_group} onChange={handleChange} className="select select-bordered">
                ...
                <div className="flex space-x-4">
                    <div className="form-control flex-1">
                        ...
                        <input type="text" name="height.feet" placeholder="Height (Feet)" value={formData.height.feet} onChange={handleChange} className="input input-bordered" />
                        {errors['height.feet'] && <span className="text-red-500">{errors['height.feet']}</span>}
                    </div>
                    <div className="form-control flex-1">
                        <label className="label">
                            <span className="label-text">Height (Inches)</span>
                        </label>
                        <input type="text" name="height.inches" placeholder="Height (Inches)" value={formData.height.inches} onChange={handleChange} className="input input-bordered" />
                        {errors['height.inches'] && <span className="text-red-500">{errors['height.inches']}</span>}
                    </div>
                </div>
                ...
                <div className="flex space-x-4">
                    <div className="form-control flex-1">
                        ...
                        <input type="text" name="weight.value" placeholder="Weight" value={formData.weight.value} onChange={handleChange} className="input input-bordered" />
                        {errors['weight.value'] && <span className="text-red-500">{errors['weight.value']}</span>}
                    </div>
                    <div className="form-control flex-1">
                        <label className="label">
                            <span className="label-text">Weight Unit</span>
                        </label>
                        <input type="text" name="weight.unit" placeholder="Weight Unit" value={formData.weight.unit} onChange={handleChange} className="input input-bordered" />
                        {errors['weight.unit'] && <span className="text-red-500">{errors['weight.unit']}</span>}
                    </div>
                </div>
                ...
                <div className="flex space-x-4">
                    <div className="form-control flex-1">
                        ...
                        <input type="text" name="emergency_contact.name" placeholder="Emergency Contact Name" value={formData.emergency_contact.name} onChange={handleChange} className="input input-bordered" />
                        {errors['emergency_contact.name'] && <span className="text-red-500">{errors['emergency_contact.name']}</span>}
                    </div>
                    <div className="form-control flex-1">
                        <label className="label">
                            <span className="label-text">Emergency Contact Phone Number</span>
                        </label>
                        <input type="text" name="emergency_contact.phone_number" placeholder="Emergency Contact Phone Number" value={formData.emergency_contact.phone_number} onChange={handleChange} className="input input-bordered" />
                        {errors['emergency_contact.phone_number'] && <span className="text-red-500">{errors['emergency_contact.phone_number']}</span>}
                    </div>
                </div>
                ...
                <div className="form-control flex-1">
                    ...
                    <input type="text" name="emergency_contact.relationship" placeholder="Emergency Contact Relationship" value={formData.emergency_contact.relationship} onChange={handleChange} className="input input-bordered" />
                    {errors['emergency_contact.relationship'] && <span className="text-red-500">{errors['emergency_contact.relationship']}</span>}
                </div>
                ...
                <div className="flex space-x-4">
                    <div className="form-control flex-1">
                        ...
                        {errors.terms_accepted && <span className="text-red-500">{errors.terms_accepted}</span>}
                    </div>
                    <div className="form-control flex-1">
                        <label className="cursor-pointer label">
                        ...
                        {errors.consent_form_signed && <span className="text-red-500">{errors.consent_form_signed}</span>}
                    </div>
                </div>
